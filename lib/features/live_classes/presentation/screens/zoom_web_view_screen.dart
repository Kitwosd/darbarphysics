...
class ZoomWebViewScreen extends StatefulWidget {
  final String url;
  const ZoomWebViewScreen({super.key, required this.url});

  @override
  State<ZoomWebViewScreen> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ZoomWebViewScreen> {
