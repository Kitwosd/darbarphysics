...
//     //Completer waits clearly for the result (think like 'call me when u're done')
...
//             switch (event) {
//               //User pressed back/ closed khalti scope
...
//                 logger.i("Network failure during payment");
//                 completer.complete(null);
//                 break;

//               // khalti couldn't check payyment status
//               case khalti.KhaltiEvent.paymentLookupfailure:
//                 logger.i('Payment lookup failed:');
//                 completer.complete(null);
//                 break;

//               // Return URL failed - harmless
//               // onPaymentResult already fired if payment succeeded
//               case khalti.KhaltiEvent.returnUrlLoadFailure:
//                 logger.w('Return URL failed (harmless if payment succeeded');
//                 break;
...
//           },
//       onReturn: () {
//         //return url loaded in webview
//         //nothing need - onPaymentResult handles success
//         logger.i('Return url loaded');
//       },
//     );
...
//       onTimeout: () {
//         logger.e('Khalti payment time out');
//         return null;
//       },
//     );
//     return result;
